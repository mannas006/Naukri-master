...
# Optional: add any Chrome options you were using
options = Options()
...
originalResumePath = "ocv/Manas_cv.pdf"
# Add Path where modified resume should be saved
modifiedResumePath = "mcv"

# Update your naukri username and password here before running
username = "manasdey.iron006@gmail.com"
password = "Manas1998d@"
mob = "9635623705"  # Type your mobile number here
